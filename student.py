...
class Student:
    ...
    # This part is image labels setting start 
        # first header image  
        img=Image.open(r"C:\Users\USER\python_Test_Projects\Images_GUI\student.jpg")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome to Student Pannel",font=("verdana",25,"bold"),bg="white",fg="navyblue")
        ...
        dep_combo["values"]=("Select Department","Computer","Civil","Mechanical","Chemical","Electrical","Geotechnical","Management")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","CSE","ME","ECE","EEE","AE","CE","BE","BCA","MCA")
        cou_combo.current(0)
        ...
        year_combo["values"]=("Select Year","2017-18","2018-19","2019-20","2020-21","2021-22","2022-23","2023-24")
