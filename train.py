...
class Train:
    ...
    def __init__(self,root):
        ...
        # first header image  
        img=Image.open(r"C:\Users\USER\python_Test_Projects\Images_GUI\train.jpg")
        ...
        # backgorund image 
        bg1=Image.open(r"C:\Users\USER\python_Test_Projects\Images_GUI\t_bg1.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"C:\Users\USER\python_Test_Projects\Images_GUI\t_btn1.png")
